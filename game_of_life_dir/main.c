...
int main(int argc, char** args) {
	...
	if (strstr(infile_str, "rle")) { //If file has RLE extension, use special RLE parser
		my_game = game_from_rle(infile); 
	}
	else {
		my_game = game_from_file(infile, rows, cols);//Get starting configuration from a file
	}
